		...
		<header>
			<div class="container-fluid">
				<div class="header d-md-flex justify-content-between align-items-center py-3 px-xl-5 px-lg-3 px-2">
					<!-- logo -->
					<div id="logo">
						<h1><a class="" href="index.html">Medical Shop</a></h1>
					</div>
					<!-- //logo -->
					<!-- nav -->
					<div class="nav_w3ls">
						<nav>
														<ul class="menu">
								<li><a href="Customer Home.php" style="color: black;" >Home</a></li>
								
								<li><a href="Customer View Profile.php" style="color: black;" >Profile</a></li>

								<li><a href="Customer Buy Product.php"  style="color: black;">Shopping</a></li>
								<li><a href="Customer View Buy Product.php"  style="color: black;">Purchased</a></li>
								<li><a href="Customer Add Complaint.php"  style="color: black;">Complaint</a></li>
			...
			<div class="row">
				<div class="col-lg-3 col-sm-6 agileinfo_footer_grid">
					...
					<div class="logo-2 mb-sm-4 mb-3">
						<h2><a href="index.html">Medical Shop</a></h2>
					</div>
					<!-- //logo -->
	...
	<div class="newsletter-main text-center py-md-5 py-4">
		<div class="container">
			...
			<div class="w3agile_footer_copy mt-sm-5 mt-4">
				<p>© 2019 Medical Shop. All rights reserved | Design by
					<a href="http://w3layouts.com/">Medical Shop.</a>
				</p>
			</div>
			<!-- //copyright -->
		</div>
